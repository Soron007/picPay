...
const PhotoManagement = () => {
  ...
  return (
    <div className="flex flex-col sm:flex-row">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 mt-5 bg-transparent sm:bg-white p-5 w-[90vw] sm:w-[55vw] sm:h-[50vh] sm:overflow-y-scroll rounded-lg mx-auto sm:mx-0">
        {posts.length> 0 && posts?.map(({_id, title, image, author, price}) => {
          return (
            <ImageCard
              key={_id}
              id={_id}
