...
const Navbar = () => {
    return (
        <nav className='flex flex-col sm:flex-row items-start sm:items-center justify-between px-5 py-5 fixed top-0 left-0 right-0 shadow-md gap-2 sm:gap-0 z-30 bg-white'>
            {/* logo and site name */}
