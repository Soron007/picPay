...
const DashboardSidebar = () => {
  ...
  return (
    <nav
      ...
      } flex sm:static text-lg font-semibold bg-white shadow-lg flex-col w-fit min-h-screen p-3 list-none justify-between items-center ease-in-out duration-300`}
    >
      <div>
        ...
        <button
          ...
          className="uppercase py-2 mt-2 text-sm w-full px-2 hover:bg-black hover:text-white ease-linear duration-300 cursor-pointer border-black text-center transition-all border-2"
        >
